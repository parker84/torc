...
export function buildCommands(): Command[] {
  const commands: Command[] = [
    ...
    },
    {
      id: 'window.new',
      title: 'New window',
      subtitle: 'A second workspace, with its own panes',
      group: 'Session',
      keywords: ['window', 'screen', 'monitor', 'workspace', 'split'],
      hint: '⌘N',
      run: () => window.torc.newWindow('shell'),
    },
    {
      id: 'window.new-agent',
      title: 'New window with an agent',
      subtitle: 'Opens the window and starts Claude Code in it',
      group: 'Session',
      keywords: ['window', 'claude', 'workspace', 'monitor'],
      hint: '⇧⌘N',
      run: () => window.torc.newWindow('claude'),
    },
    {
